    ...
    color:black;
        ...
        body {
            font-family: 'Roboto';
             ...
             width: 100%;
              height: 100vh;
              background-image: linear-gradient(rgba(252, 252, 252, 0.8),rgba(127, 127, 150, 0.8)), url(images/libr2.jpeg);
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <label>Title:</label><input  type="text" name="bookdetail"/></br>
            <label>Author:</label><input type="text" name="bookaudor"/></br>
            <label>Publication</label><input type="text" name="bookpub"/></br>
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BSIT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>CS<input type="radio" name="branch" value="BSSE"/>SE</div>
            </div>   
...
?>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style=' 
            padding: 8px;'>Book Name</th><th>Price</th><th>Qnt</th><th>Available</th><th>issue</th></th><th>View</th></tr>";
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
                $table.="<td>$row[2]</td>";
